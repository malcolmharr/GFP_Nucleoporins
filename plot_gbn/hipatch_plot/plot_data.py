...
"""pred116 = np.polyfit(mean_dg, logP116, 1)
pred98A = np.polyfit(mean_dg, logP98A, 1)
...
ax[0].scatter(mean_dg, P116, s=10, c='g', lw=0.5, edgecolors='k')
...
ax[1].scatter(mean_dg, P98A, s=10, c='darkorchid', lw=0.5, edgecolors='k')
