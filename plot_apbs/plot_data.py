...
ax[0].plot([-10000,-9000], np.exp(LinFit(np.array([-10000,-9000]), *popt116)), c='g', lw=1, label=r'ln(P)=%.4f$\Delta G_{hyd}$+%.1f'%(popt116[0], popt116[1]))
ax[0].set_xlabel('')
ax[0].set_xlim(-10000,-9000)
ax[0].set_xticks([-10000,-9666,-9333,-9000])
...
ax[1].plot([-10000,-9000], np.exp(LinFit(np.array([-10000,-9000]), *popt98A)), c='darkorchid', lw=1, label=r'ln(P)=%.4f$\Delta G_{hyd}$+%.1f'%(popt98A[0], popt98A[1]))
ax[1].set_xlabel(r'$\Delta G_{hyd}$ (kJ/mol)', fontsize=10)
ax[1].set_xlim(-10000,-9000)
