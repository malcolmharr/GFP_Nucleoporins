...
ax[0].plot([-10050,-9050], np.exp(LinFit(np.array([-10050,-9050]), *popt116)), c='g', lw=1, label=r'ln(P)=%.4f$\Delta G_{hyd}$+%.1f'%(popt116[0], popt116[1]))
ax[0].set_xlabel('')
...
ax[1].plot([-10050,-9050], np.exp(LinFit(np.array([-10050,-9050]), *popt98A)), c='darkorchid', lw=1, label=r'ln(P)=%.4f$\Delta G_{hyd}$+%.1f'%(popt98A[0], popt98A[1]))
